...
def main():
    ...
    # 2) Ймовірність, що всі 50 доставлять вчасно: P(X = 50)
    p_x_50 = binom.pmf(50, n, p)

    # 3) Ймовірність, що рівно 45 доставлять вчасно: P(X = 45)
    p_x_45 = binom.pmf(45, n, p)

    # 4) Ймовірність, що вчасно доставлять від 42 до 46: P(42 <= X <= 46) = F(46) - F(41)
    p_42_46 = binom.cdf(46, n, p) - binom.cdf(41, n, p)

    # 5) Ймовірність, що більше 5 замовлень запізняться:
